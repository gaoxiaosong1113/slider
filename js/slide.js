!function () {
    ...
    var Slider = {
        ...
        init: function (options) {
            ...
            this.options.slideBox = this.options.slide.querySelector('.slider-box');
            this.options.sMain = this.options.slide.querySelectorAll('.sMain');
            this.options.slideItem = this.options.slide.querySelector('.slider-item');
            this.options.sItem = this.options.slideItem.querySelectorAll('li');
            this.options.leftBtn = this.options.slide.querySelector(".slider-btn-left");
            this.options.rightBtn = this.options.slide.querySelector(".slider-btn-right");
